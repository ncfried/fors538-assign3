...
par(op)
```
## Training/Validation Using Predicted vs. Observed Regression 
...
plot(data.valid$ANPP, pred_valid,
     xlab = "Observed ANPP", ylab = "Predicted ANPP", main= "GLM Validation: Observed vs Predicted")
